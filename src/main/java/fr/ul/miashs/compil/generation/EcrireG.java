...
public class EcrireG extends InstructionG {
    public StringBuilder generer_ecrire(Noeud ecrire) {
        ...
        expr.generer_expression(ecrire.getFils().get(0), expr.getId(),false); // en generant l'exp (qui gère aussi le cas d'une constante ou d'un idf) on sait qu'il y a en haut de la pile le result à print
